...
- [2026-09-09 변화 바람·속도 초기화 비교](2026-09-09_02_teacher_velocity_reset.md): Native 고정 폭 실패 후 사용자 선택으로 P3 작은 굽힘 연결. 새 물리 검증·전체 재실행과76개 patch sample의 원본/batch 검증 완료.
